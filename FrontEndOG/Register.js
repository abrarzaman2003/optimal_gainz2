...
import {makeUser} from '../Firebase/functions.js';
...
<View style={[styles.container, {
            ...
            <View style={{marginVertical: 245,width: 350,borderRadius:30,paddingTop:10, alignSelf:'center' ,alignItems:'center', position: 'absolute'}}>
                ...
                <Field placeholder="First Name" onChangeText= {newText => setUserName(newText)}/>
                ...
                <Btn onPress={() => handleRegister()} brdRadius={40}  brdWidth={'1'} brdColor={'#53595D'} btnWidth={150} txtSize={14} textColor='#0D0D0D' btnLabel="Register" />
